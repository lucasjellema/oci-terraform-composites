...
resource "oci_identity_dynamic_group" "devops_deployment_pipeline_dg" {
  ...
  name           = "${var.application_name}-devops-deployment-pipeline-dg"
  description    = "${var.application_name} DevOps Deployment Pipeline Dynamic Group"
...
resource "oci_identity_dynamic_group" "devops_build_pipeline_dg" {
  compartment_id = var.tenancy_ocid
  name           = "${var.application_name}-devops_build_pipeline_dg"
  description    = "${var.application_name} DevOps Build Pipeline Dynamic Group"
